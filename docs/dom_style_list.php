...
<h3>Border/Outline properties</h3>
<table class="reference table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
  ...
  <tr>
    <td>border</td>
    <td>Sets or returns border-width, border-style, and border-color in one 
	declaration</td>
 ...
 <h3>Generated Content Properties</h3>
<table class="reference table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
  ...
  <tr>
    <td>content</td>
    <td>Sets or returns the generated content before or after the element</td>
  </tr>
	<tr>
    <td>counterIncrement</td>
    <td>Sets or returns the list of counters and increment values</td>
  </tr>
	<tr>
    <td>counterReset</td>
    <td>Sets or returns the list of counters and their initial values</td>
  </tr>
</tbody></table>
  
  
<h2><a name="list">List properties</h2>
<table class="reference table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
  ...
  <tr>
    <td>listStyle</td>
    <td>Sets or returns list-style-image, list-style-position, and 
	list-style-type in one 
	declaration</td>
  ...
  <h2><a name="marginpadding">Margin/Padding properties</h2>
<table class="reference table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
...
<h2><a name="positioning">Positioning/Layout properties</h2>
<table class="reference table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
  ...
  <tr>
    <td>cssFloat</td>
    <td>Sets or returns the horizontal alignment of an object</td>
  ...
  <h2><a name="printing">Printing properties</h2>
<table class="reference  table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
  ...
  <tr>
	...
	visible at the bottom of a page</td>
...
<table class="reference table">
  ...
  <tr>
    ...
    <td>Sets or returns whether the table border should be collapsed into a 
single border, or not</td>
  ...
  <tr>
    <td>emptyCells</td>
    <td>Sets or returns whether to show the border and background of empty cells, 
	or not</td>
    
  </tr>
  <tr>
    <td>tableLayout</td>
    <td>Sets or returns the way to lay out table cells, rows, 
	and columns</td>
...
<h2><a name="text">Text properties</h2>
<table class="reference table">
  <tbody><tr>
    <th align="left" width="30%">Property</th>
    <th align="left" width="63%">Description</th>
  ...
  <tr>
    <td>font</td>
    <td>Sets or returns font-style, font-variant, font-weight, font-size, 
	line-height, and font-family in one declaration</td>
    
  </tr>
  <tr>
    <td>fontFamily</td>
    <td>Sets or returns the font face for text</td>
  ...
  <tr>
    ...
    <td>Sets or returns the font aspect value</td>
  ...
  <tr>
    <td>textTransform</td>
    <td>Sets or returns the case of a text</td>
    
  </tr>
  <tr>
    <td>unicodeBidi</td>
    <td>Sets or returns whether the text should be overridden to support 
