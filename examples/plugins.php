...
<?php 
echo $ajax->format->dialog(ob_get_clean(),"Creating Plugins");
?>
...
echo $ajax->format->dialog(ob_get_clean(),"Hello World Sample Plugin");
?>
...
<?php 
echo $ajax->format->dialog(ob_get_clean(),"Creating a PHP Class for plugin");
?>
